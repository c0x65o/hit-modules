...
def get_module_version(module_name: str | None = None, package_name: str | None = None) -> str:
        ...
        for base_path in search_paths:
            ...
            if pyproject_path.exists():
                try:
                    ...
                    logger.debug("Could not read version from %s: %s", pyproject_path, e)
                    continue
    except ImportError:
...
def log_module_startup(module_name: str | None = None, version: str | None = None) -> None:
